...
Callers may rely on this contract. In particular, a stable sort by score alone preserves alphabetical order between words with equal scores; an additional alphabetical sort is redundant. Tests should compare DAWG result arrays directly rather than sorting them first.
