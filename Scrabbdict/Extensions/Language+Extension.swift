...
extension Language {
    private enum Constants {
        ...
        static let polishLetterPoints: [Character: Int] = ["A": 1, "Ą": 5, "B": 3, "C": 2, "Ć": 6, "D": 2, "E": 1, "Ę": 5, "F": 5, "G": 3, "H": 3, "I": 1, "J": 3, "K": 2, "L": 2, "Ł": 3, "M": 2, "N": 1, "Ń": 7, "O": 1, "Ó": 5, "P": 2, "R": 1, "S": 1, "Ś": 5, "T": 2, "U": 3, "V": 4, "W": 1, "X": 8, "Y": 2, "Z": 1, "Ź": 9, "Ż": 5]
    }
    
    private var letterPoints: [Character: Int] {
        switch self {
        case .englishUS, .englishGB:
            return Constants.englishLetterPoints
        case .french:
            return Constants.frenchLetterPoints
        case .polish:
            return Constants.polishLetterPoints
        }
    }

    func points(for word: String) -> Int {
        let letterPoints = self.letterPoints
